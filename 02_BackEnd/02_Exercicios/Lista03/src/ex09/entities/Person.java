...
public class Person extends Contact {
    private static final int DOCUMENT_ID_DIGITS_NUMBER = 11;

    public Person(String name, String primaryPhoneNumber, String secondaryPhoneNumber, String docId) throws InvalidDocumentIdException{
